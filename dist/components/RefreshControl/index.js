...
icon:_react2.default.createElement('img',{width:22,height:22,src:arrowIcon,className:'pull-down-icon',__source:{fileName:_jsxFileName,lineNumber:67}}),
loading:_react2.default.createElement('div',{className:'loading',__source:{fileName:_jsxFileName,lineNumber:68}},_react2.default.createElement(_reactNativeWeb.ActivityIndicator,{animating:true,__source:{fileName:_jsxFileName,lineNumber:68}})),
onRefresh:this.handleRefresh.bind(this),__source:{fileName:_jsxFileName,lineNumber:66}},
this.props.children));


}}]);return RefreshControl;}(_react.Component);process.env.NODE_ENV!=="production"?RefreshControl.propTypes={children:_react2.default.PropTypes.any,onRefresh:_react2.default.PropTypes.func.isRequired,refreshing:_react2.default.PropTypes.bool.isRequired,style:_react2.default.PropTypes.any}:void 0;exports.default=
