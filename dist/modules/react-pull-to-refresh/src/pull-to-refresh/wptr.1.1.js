...
WebPullToRefresh;var _hammer=require('./hammerjs/hammer');var _hammer2=_interopRequireDefault(_hammer);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}function WebPullToRefresh(){
'use strict';
...
var h=new _hammer2.default(options.contentEl,options.hammerOptions);

h.get('pan').set({direction:_hammer2.default.DIRECTION_VERTICAL});
