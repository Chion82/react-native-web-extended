        ...
        return (
            <TouchableOpacity style={{
                ...
                <View style={{
                    ...
                    {this.props.displayIcon && (<Image resizeMode="stretch" source={this.props.displayIcon} style={
                        this.getImageStyle()
                    } />)}

                    {this.props.iconComponent}

                    {this.props.badge && (<Text style={this.getBadgeStyle()}>{this.props.badge}</Text>)}
                </View>
